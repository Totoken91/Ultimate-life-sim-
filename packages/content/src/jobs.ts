...
export const JOBS: Record<string, JobDef> = Object.fromEntries(
  [
    ...
    job({
      ...
      trains: { forge: 2.2, artisanat: 0.8 }, danger: 18, prestige: 8,
    ...
    job({
      ...
      trains: { navigation: 1.4, commandement: 1.5 }, danger: 40, prestige: 30,
    ...
    job({
      ...
      trains: { negoce: 1.8, calcul: 0.6 }, danger: 30, prestige: 7,
    ...
    job({
      ...
      trains: { negoce: 1.5, calcul: 1.2 }, danger: 18, prestige: 35,
    ...
    job({
      ...
      trains: { negoce: 1, commandement: 1 }, danger: 12, prestige: 55,
    ...
    job({
      ...
      trains: { lettres: 2, calcul: 1 }, danger: 5, prestige: 28,
    ...
    job({
      ...
      trains: { negoce: 1.4, intrigue: 1.6 }, danger: 50, prestige: 5,
    ...
    job({
      ...
      trains: { rhetorique: 1.6, lettres: 1 }, danger: 10, prestige: 36,
    ...
    job({
      ...
      trains: { calcul: 1.4, intrigue: 1.4 }, danger: 15, prestige: 52,
